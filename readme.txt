...
Tested up to: 4.7.5
Stable tag: 4.5
This plugin will display the distance & driving direction between two points on earth. (No support provided).
== Description ==
...
Usage:
Add the following shortcode in the page: <code>[AB-MAP]</code>

Created By: Aboobacker P Ummer

Email : aboobackerp@gmail.com

Free version demo: [wp.aboobacker.com](http://wp.aboobacker.com)

Have a look to the premium version of AB Google Map Travel plugin with many exciting features here: [map.aboobacker.com](http://map.aboobacker.com)

* Multiple vehicle/cab types
* Option to set different fares for different cab types
* PayPal elxpress checkout payment integration
* Bookings are saved in the backend and email notifications upon bookings
...
<ul>
 <li>Added auto complete for from and to fields</li>
 <li>Added developer's MAP API key</li>
 <li>More to come in premium version soon</li>
</ul>
= 4.1=
Released on 23/02/2016
<ul>
 <li>Compatible with Wordpress 4.4.2</li>
</ul>
= 4.0=
